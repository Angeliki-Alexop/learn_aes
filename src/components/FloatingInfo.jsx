...
export default function FloatingInfo({
  ...
  const minimalForResult = {
    what: "The step-by-step AES process has now been completed!\n This page presents a complete overview of the AES encryption outcome, showing how the original input text and encryption key are processed and transformed into the final ciphertext.",
